  ...
  const getAvailableSlots = () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      while (currentDate < endTime) {
        ...
        const slotBooked = docInfo?.slots_booked?.[slotDate]?.includes(formattedTime)
    ...
    <div>
      ...
      <div className="sm:ml-72 sm:pl-4 mt-8 font-medium text-[#565656]">
        ...
        <button
          ...
          className="bg-primary text-white text-sm font-light px-20 py-3 rounded-full my-6 hover:scale-105 transition-all duration-300"
        >
          Book an appointment
        </button>
      </div>
